...
public class MainActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinner = (Spinner)findViewById(R.id.spinner1);
		 ...
		 edt1.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				 try{
                     seek_bar1.setProgress(Integer.parseInt(s.toString()));
                 } catch(Exception ex) {}
		 ...
		 edt2.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				try{
                    ...
                    seek_bar2.setProgress(Integer.parseInt(s.toString()));
                } catch(Exception ex) {}
        ...
        final HashMap<String, Double> krediTipi = new HashMap<String, Double>();			
	     krediTipi.put("Bireysel Ýhtiyaç Kredisi",1.18);
	     krediTipi.put("Eðitim Kredisi",1.29);
	     krediTipi.put("Ýpotekli Bireysel Fin.Krd.",1.19);
	     krediTipi.put("Kaskolu 0 Km. Taþýt",1.4);
	     krediTipi.put("Kaskolu 2. El Taþýt",1.45);
	     krediTipi.put("Kaskosuz 0 Km. Taþýt",1.45);
	     krediTipi.put("Kaskosuz 2. El Taþýt",1.5);
